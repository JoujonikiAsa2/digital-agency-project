    ...
    return (
        <form className='static px-3'>
            <div className='text-center flex flex-col justify-center items-center py-20 space-y-3'>
                ...
                <h3 className='text-2xl font-medium w-80'>Subscribe to get the latest news about us</h3>
                <fieldset className="form-control w-96 ">
                    <label className="label">
                        <span className="label-text text-[#8B8B8B]">Please drop your email below to get daily update about what we do</span>
                    </label>
